    ...
    <div className="min-h-screen bg-bg-warm flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white border border-border-warm rounded-2xl p-8 shadow-sm">
          ...
          <p className="text-text-muted text-sm mb-6">Start vetting candidates in minutes.</p>
          ...
          <p className="text-sm text-text-muted text-center mt-6">
            ...
            <Link href="/auth/login" className="text-primary-light hover:text-primary font-medium">
              Sign in
            </Link>
          </p>
        </div>
